...
export default function SideNav() {
  ...
  return (
    <>
      <nav
        id="sidenav-8"
        className="relative left-0 top-0 z-[1035] h-full w-60 translate-x-100 overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)]  dark:bg-zinc-800"
      >
        <Link
          className="mb-3 flex items-center justify-start border-b-2 border-solid border-gray-100 py-6 outline-none"
          href="/"
        >
          <img
            id="te-logo"
